...
using fjrg76::components::Blink::Blink;
...
#ifdef PLATFORM_ARDUINO
    Led led_arduino( 13 );
    fjrg76::components::Blink::Blink led13( led_arduino );
#endif
...
#if 0 // using fully qualifed names:
    led13.begin( fjrg76::components::Blink::Blink::ePolarity::ACTIVE_HIGH );
    led13.set( fjrg76::components::Blink::Blink::eMode::FOREVER, 2, 3 );
#endif  
